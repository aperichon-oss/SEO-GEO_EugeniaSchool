  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-4xl mt-12">
              ...
              <h1 className="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight mb-8">
                Bachelor <span className="text-[#FF6B2B]">AI Applied to Business</span> (Hors Parcoursup)
              </h1>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10 border-t border-b border-[#2A2A2A] py-8">
                ...
                <div>
                  ...
                  <div className="font-bold text-xl text-[#FF6B2B]">Hors Parcoursup</div>
                </div>
                <div>
              ...
              <div className="relative pl-8 md:pl-0">
                <div className="md:grid md:grid-cols-[120px_1fr] gap-8 relative">
                  ...
                  <div className="bg-[#0A0A0A] text-white p-8 rounded-2xl border border-[#2A2A2A]">
                    <div className="inline-block bg-[#FF6B2B] text-[#0A0A0A] text-[10px] font-bold px-2 py-1 rounded mb-4 uppercase tracking-wider">Alternance possible</div>
        ...
        {/* ADMISSION CTA */}
        <section className="py-24 bg-[#FF6B2B]">
