        ...
        <div className="bg-[#0A0A0A] text-white pt-12 pb-24 border-b border-[#2A2A2A]">
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-4xl mt-8">
              <div className="inline-block bg-[#FF6B2B] text-[#0A0A0A] text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-6">Rentrées 2026</div>
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold mb-6 tracking-tight">
                Processus <span className="text-[#FF6B2B]">d'admission</span>
              </h1>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="flex flex-col md:flex-row gap-6 bg-white p-8 rounded-2xl border border-[#E0DDD8] shadow-sm relative overflow-hidden group hover:border-[#0A0A0A] transition-colors">
                  <div className="absolute top-0 left-0 bottom-0 w-2 bg-[#0A0A0A] group-hover:bg-[#FF6B2B] transition-colors"></div>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0A0A0A] mb-2 flex items-center gap-2"><FileText className="w-5 h-5 text-[#FF6B2B]" /> Candidature en ligne</h3>
                ...
                <div className="flex flex-col md:flex-row gap-6 bg-white p-8 rounded-2xl border border-[#E0DDD8] shadow-sm relative overflow-hidden group hover:border-[#0A0A0A] transition-colors">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0A0A0A] mb-2 flex items-center gap-2"><UserPlus className="w-5 h-5 text-[#FF6B2B]" /> Entretien de motivation</h3>
                ...
                <div className="flex flex-col md:flex-row gap-6 bg-white p-8 rounded-2xl border border-[#E0DDD8] shadow-sm relative overflow-hidden group hover:border-[#0A0A0A] transition-colors">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0A0A0A] mb-2 flex items-center gap-2"><CheckCircle2 className="w-5 h-5 text-[#FF6B2B]" /> Décision d'admission</h3>
                ...
                <div className="flex flex-col md:flex-row gap-6 bg-white p-8 rounded-2xl border border-[#E0DDD8] shadow-sm relative overflow-hidden group hover:border-[#0A0A0A] transition-colors">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0A0A0A] mb-2 flex items-center gap-2"><Calendar className="w-5 h-5 text-[#FF6B2B]" /> Inscription & Rentrée</h3>
              ...
              <div className="mt-12 text-center">
                <Link href="/candidature" className="inline-flex justify-center items-center gap-2 bg-[#0A0A0A] text-white px-8 py-4 rounded-full font-bold text-lg transition-all hover:bg-[#FF6B2B] hover:text-[#0A0A0A]">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#1A1A1A] mb-6">
                  <CreditCard className="w-8 h-8 text-[#FF6B2B]" />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-[#111111] p-8 rounded-2xl border border-[#2A2A2A]">
                  <div className="inline-block bg-[#FF6B2B] text-[#0A0A0A] text-[10px] font-bold px-2 py-1 rounded mb-4 uppercase tracking-wider">Recommandé</div>
